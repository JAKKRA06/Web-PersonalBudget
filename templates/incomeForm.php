                ...
                <article class="row">
                    <label class="col-sm-4 label">Kwota</label>
                        <div class="col-sm-8 label">
                            <input type="text" name="income_amount" class="form-control" id="kwota" placeholder="kwota" onfocus="this.placeholder=''" onblur="this.placeholder='kwota'" value="<?php
if (isset($_SESSION['amountIncomeRemember'])) {
    echo $_SESSION['amountIncomeRemember'];
    unset($_SESSION['amountIncomeRemember']);
}
?>">                             
                        </div>
                </article>
                ...
                <article class="row">
                    <label class="col-sm-4 label">Komentarz</label>
                        <div class="col-sm-8 label">
                      <input type="text" name="income_comment" class="form-control" placeholder="opcjonalnie" onfocus="this.placeholder=''" onblur="this.placeholder='opcjonalnie'" value="<?php
if (isset($_SESSION['commentIncomeRemember'])) {
    echo $_SESSION['commentIncomeRemember'];
    unset($_SESSION['commentIncomeRemember']);
}
?>">
                    </div>
                </article>
