        ...
        <article class="active" id="balance">
            <div class="row">
            	<div class="col-sm-12">
                    ...
                    <?php  $idRecordToModify = $_GET['expenseId']?>
                    <?php  $peroid           = $_GET['peroid']?>
                    <?php  if(isset($_GET['startDate'])) { $startDate = $_GET['startDate']; } else { $startDate = '';}?>
                    <?php  if(isset($_GET['startDate'])) {$lastDate   = $_GET['lastDate']; } else { $lastDate = '';}?>
